...
LEXICON: Dict[str, str] = {
    ...
    'enter_new_freq': 'Пожалуйста, введите новую частоту отслеживания *в минутах*.',
    'success_change_freq': 'Частота обновлений успешно обновлена с {prev_freq} мин. на {new_freq} мин.'
}
